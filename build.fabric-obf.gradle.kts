...
dependencies {
    ...
    // Obfuscated nodes run named (Mojang) mappings, so Loom remaps these via the mod* configurations.
    modRuntimeOnly(fletchingTable.modrinth("cushions-backport", property("minecraft_version") as String, "fabric"))
